...
export const About = () => {
    ...
    const frontendSkills = ["Vite", "React", "Tailwind CSS", "GSAP", "TypeScript", "Axios"];
    const backendSkills = ["Node", "MySQL", "MongoDB"];
            ...
            <RevealOnScroll>       
                <div className="max-w-5xl mx-auto px-4">
                    ...
                    <div className="rounded-xl p-8 border-black/10 dark:border-white/10 border hover:-translate-y-1 transition-all">
                        ...
                        <h3 className="text-xl font-bold mb-4">Skills and Programs – Junior DevOps</h3>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
                        ...
                        <div className="p-6 rounded-xl border-black/10 dark:border-white/10 border hover:-translate-y-1 transition-all">
                            ...
                            <h3 className="text-xl font-bold mb-4">Skills and Programs – Junior Full Stack Developer</h3>
                        ...
                        <div className="p-6 rounded-xl border-black/10 dark:border-white/10 border hover:-translate-y-1 transition-all">
                            ...
                            <div className="space-y-4 text-gray-500 dark:text-gray-300">
                                <div>
                                    ...
                                    <p className="text-gray-400 mb-2">UPF (Barcelona [ES], 2021-2025)</p>
                                </div>
                                <div>
                                    Erasmus - Bachelor's degree in Translation and Interpreting
                                    <p className="text-gray-400 mb-2">Université de Lorraine (Nancy [FR], 2023)</p>
                                </div>
                                <div>
                                    Advanced vocational trining, Web Application Development
                                    <p className="text-gray-400 mb-2">INS La Pineda (Badalona [ES], 2018-2020)</p>
                                </div>
                                <div>
                                    Intermediate vocational trining, Microcomputer Systems and Networks
                                    <p className="text-gray-400 mb-2">Escoles Freta (Calella [ES], 2016-2018)</p>
                                </div>
                            </div>
                        </div>
                        <div className="p-6 rounded-xl border-black/10 dark:border-white/10 border hover:-translate-y-1 transition-all">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
                        ...
                        <div className="p-6 rounded-xl border-black/10 dark:border-white/10 border hover:-translate-y-1 transition-all">
                            ...
                            <div className="space-y-4 text-gray-500 dark:text-gray-300">
                                <div>
                                    <h4>DevOps Beginners to Advanced</h4>
                                    <p className="text-gray-400 mb-2">Udemy</p>
                                    <a href="https://www.udemy.com/certificate/UC-a9bb71e6-68c5-453d-ba64-4879ccdf0573/" className="text-blue-400 hover:text-blue-300 transition-colors my-4" target="_blank" rel="noopener noreferrer">View Credential →</a>
                                </div>
                                <div>
